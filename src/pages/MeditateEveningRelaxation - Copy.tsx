  ...
  const eveningActivities = [
    {
      ...
      steps: [
        { text: "Find a comfortable position and allow your eyes to close gently. Let your shoulders drop.", duration: 25 },
        { text: "Take a deep breath in, then exhale slowly while mentally saying 'I release the day.'", duration: 35 },
        { text: "Continue breathing naturally, letting each exhale carry away any stress or worry.", duration: 45 },
        { text: "Feel your body becoming heavier and more relaxed with each breath.", duration: 40 },
        { text: "Allow yourself to fully arrive in this peaceful moment of transition.", duration: 35 }
      ]
    },
    {
      id: 'reflection',
      ...
      interactive: true,
      steps: [
        { text: "Take a moment to gently look back at your day without judgment.", duration: 30 },
        { text: "What moments brought you joy or satisfaction today? Honor these experiences.", duration: 50 },
        { text: "Were there any challenges? Acknowledge them with compassion for yourself.", duration: 50 },
        { text: "What did you learn about yourself or others today? Every experience teaches us something.", duration: 50 },
        { text: "Send yourself appreciation for navigating another day of life with awareness.", duration: 40 }
      ]
    },
    {
      id: 'gratitude',
      ...
      interactive: true,
      steps: [
        { text: "Place your hand on your heart and take three deep, appreciative breaths.", duration: 30 },
        { text: "Think of a person who made your day a little brighter, even in a small way.", duration: 45 },
        { text: "Recall a moment of beauty you witnessed - perhaps nature, art, or human kindness.", duration: 45 },
        { text: "Appreciate something about your body that served you well today.", duration: 45 },
        { text: "Feel gratitude for having another day to experience life in all its forms.", duration: 35 }
      ]
    },
    {
      id: 'preparation',
      ...
      interactive: true,
      steps: [
        { text: "Begin to slow down your breathing, making each breath deeper and more relaxed.", duration: 40 },
        { text: "Starting from your toes, consciously relax each part of your body, working upward.", duration: 60 },
        { text: "Let go of any thoughts about tomorrow - trust that you'll handle what comes with wisdom.", duration: 55 },
        { text: "Imagine yourself surrounded by a soft, protective bubble of peace and safety.", duration: 50 },
        { text: "Set an intention for restful sleep and dreams that nourish your soul.", duration: 45 },
        { text: "Allow yourself to drift into a state of complete relaxation and trust.", duration: 50 }
      ]
    }
  ];
        ...
        <div className="max-w-3xl mx-auto text-center space-y-6 px-4">
          ...
          {completedSections.length === eveningActivities.length && (
            <motion.div
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
              className="bg-gradient-to-r from-purple-50 to-indigo-50 border border-purple-200 rounded-xl p-6 text-center backdrop-blur-sm"
            >
              <div className="text-purple-700 text-2xl font-bold mb-2">
