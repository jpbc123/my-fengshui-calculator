  ...
  const morningActivities = [
    {
      ...
      steps: [
        { text: "Find a comfortable seated position. Close your eyes or soften your gaze.", duration: 20 },
        { text: "Take a deep breath in through your nose for 4 counts, feeling your chest rise.", duration: 30 },
        { text: "Hold your breath gently for 2 counts, feeling the stillness within.", duration: 30 },
        { text: "Exhale slowly through your mouth for 6 counts, releasing any tension.", duration: 40 },
        { text: "Continue this rhythm, letting each breath bring you into the present moment.", duration: 60 }
      ]
    },
    {
      id: 'gratitude',
      ...
      interactive: true,
      steps: [
        { text: "Take a moment to connect with your heart and think about what you appreciate in your life.", duration: 30 },
        { text: "Reflect on something simple that brings you joy - perhaps the morning light, a comfortable bed, or a loved one.", duration: 45 },
        { text: "Consider a recent experience or achievement you're thankful for.", duration: 45 },
        { text: "Think of a person who has positively impacted your life and feel gratitude for their presence.", duration: 45 },
        { text: "Let these feelings of appreciation fill your entire being, setting a positive tone for your day.", duration: 30 }
      ]
    },
    {
      id: 'intention',
      ...
      interactive: true,
      steps: [
        { text: "Take three deep breaths and connect with your inner wisdom.", duration: 30 },
        { text: "Ask yourself: 'How do I want to feel today?' Listen to what arises.", duration: 45 },
        { text: "Consider: 'What kind of energy do I want to bring to my interactions?'", duration: 45 },
        { text: "Reflect on: 'What would make today feel meaningful and fulfilling?'", duration: 45 },
        { text: "Formulate your intention as a simple, positive statement you can carry with you.", duration: 60 }
      ]
    },
    {
      id: 'body-scan',
      ...
      steps: [
        { text: "Sit or lie comfortably and take a few deep breaths to center yourself.", duration: 30 },
        { text: "Starting from the top of your head, gently notice any sensations without judgment.", duration: 45 },
        { text: "Move your attention down through your face, neck, and shoulders, releasing any tension.", duration: 60 },
        { text: "Continue through your arms, chest, and torso, appreciating your body's strength.", duration: 60 },
        { text: "Finish by noticing your legs and feet, feeling gratitude for carrying you through life.", duration: 45 },
        { text: "Take a moment to appreciate your entire body and set an intention to treat it with kindness today.", duration: 30 }
      ]
    }
  ];
              ...
              {(gratitudeItems.some(item => item.trim()) || dailyIntention.trim()) && (
                <div className="bg-white/80 rounded-lg p-4 mb-4 text-left">
                  ...
                  <div className="mt-4 pt-3 border-t border-gray-200 text-xs text-gray-500 text-center">
                    Screenshot this summary to keep your morning reflections with you throughout the day
                  </div>
                </div>
              )}
