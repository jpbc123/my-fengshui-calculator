    ...
    const fetchRelatedArticles = async () => {
      try {
        const { data, error } = await supabase
          ...
          .select("articles(title, url_slug, publish_date)") // Select publish_date for ordering
          .eq("calculator_type", "Feng Shui")
          .order("publish_date", { foreignTable: 'articles', ascending: false }) // Corrected order clause
          .limit(3);
        ...
        // The query returns an array of objects like [{ articles: { ... } }, { articles: { ... } }]
        // We need to map over it to get a clean array of articles.
        if (data) {
          const articlesData = data.map(item => item.articles);
                ...
                <div className="flex items-start gap-2 text-black/80 bg-gray-50 p-4 rounded-xl border border-gray-200">
                  ...
                  <div className="text-left">
                    <p>
                      ...
                      <span className className="font-semibold">lucky directions</span> to find the best
                ...
                >
                  ...
                  <div className="space-y-4 text-black/90">
                    ...
                    <div>
                      ...
                      <ul className="list-disc list-inside">
                        <li>
                          Face your lucky direction when working or studying.
                        </li>
                        <li>
                          Position your bed so your head points toward a lucky
                          direction.
                        </li>
                        <li>
                          Place your main door to align with your most favorable
                          direction.
                        </li>
                      </ul>
                    </div>
