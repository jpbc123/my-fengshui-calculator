...
import { Calendar, Clock, MapPin, Star, Download, CreditCard, ArrowRight, Check } from 'lucide-react';
...
const generateReceipt = () => {
  ...
  try {
    ...
    pdf.setFontSize(12);
    pdf.setFont('helvetica', 'bold');
    pdf.text('Amount Paid: $6.99 USD', 20, yPos);
    yPos += 8;
    pdf.setFont('helvetica', 'normal');
    pdf.text('Payment Method: Credit Card', 20, yPos);
    yPos += 7;
...
// Test function to verify button click is working
        ...
        <div className="grid lg:grid-cols-3 gap-8">
          <div className="lg:col-span-2">
            ...
            >
              ...
              {/* Steps and Form remain the same */}
              ...
              <Card className="border border-gray-200 shadow-lg">
                <CardHeader>
                  <CardTitle className="text-2xl text-center">
                    ...
                    {currentStep === 2 && "Complete Your Purchase"}
                    {currentStep === 3 && "Your Chart is Ready!"}
                  </CardTitle>
                </CardHeader>
                <CardContent className="p-8">
                  {/* Form content - keeping your existing form logic */}
                  {currentStep === 1 && (
                    <div className="space-y-6">
                      ...
                      >
                        Continue to Payment <ArrowRight className="inline ml-2 w-5 h-5" />
                      </button>
                    </div>
                  )}
                    ...
                    <div className="text-center space-y-6">
                      {isDev && skipPayment && (
                        <div className="bg-yellow-100 border-l-4 border-yellow-500 p-4 mb-4">
                          <p className="text-yellow-700 text-sm">🚧 Development Mode - Payment Bypassed</p>
                        </div>
                      )}
                      ...
                      <div className="bg-purple-50 rounded-lg p-6">
                        ...
                        <div className="space-y-2 text-sm text-gray-600 mb-4">
                          ...
                          <div className="flex justify-between">
                            <span>Birth:</span>
                            <span className="font-medium">{formData.birthDate} at {formData.birthTime}</span>
                          </div>
                          <div className="flex justify-between">
                            <span>Location:</span>
                            <span className="font-medium">{selectedLocationDisplay || formData.birthLocation}</span>
                          </div>
                        </div>
                        <div className="border-t pt-4 flex justify-between items-center text-lg text-black">
                          <span>Professional Birth Chart Analysis</span>
                          <span className="font-bold text-purple-600">$6.99</span>
                        </div>
                      </div>
                      ...
                      >
                        {isProcessing ? (
                          ...
                          <>
                            ...
                            {isDev && skipPayment ? 'Simulate Payment' : 'Secure Checkout with Stripe'}
                          </>
                        )}
                      </button>
                  ...
                  {currentStep === 3 && (
                    <div className="text-center space-y-6">
                      ...
                      <h3 className="text-2xl font-semibold text-green-600">
                        {isDev && skipPayment ? 'Test Successful!' : 'Payment Successful!'}
                      </h3>
              ...
              <CardContent className="p-6">
                ...
                <div className="mt-6 p-4 bg-purple-50 rounded-lg relative overflow-hidden">
                  ...
                  <div className="text-center relative z-10">
                    <div className="text-2xl font-bold text-purple-600">$6.99</div>
                    <div className="text-sm text-gray-600">One-time payment</div>
                    <div className="text-xs text-gray-500 mt-1">No subscriptions, no automatic registrations</div>
                  </div>
                </div>
              </CardContent>
            </Card>
                ...
                <div className="text-center space-y-4">
                  ...
                  <div className="pt-4 border-t">
                    ...
                    <p className="text-xs text-gray-500">
                      Be one of the first satisfied customers worldwide
                    </p>
                  </div>
                </div>
              </CardContent>
