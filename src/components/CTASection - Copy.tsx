...
const CTASection = ({ onStartCalculation }: CTASectionProps) => {
  return (
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="flex flex-col sm:flex-row justify-center gap-4">
          <button
            ...
            className="bg-gold text-black font-semibold px-6 py-3 rounded-full shadow-md hover:bg-yellow-400 transition"
          >
            Start Your Calculation
          </button>
          <button className="bg-transparent border-2 border-white px-6 py-3 rounded-full text-white hover:bg-white hover:text-black transition">
            Learn More
          </button>
        </div>
      </div>
