...
export default function AboutUsSection() {
  ...
  const services = [
	...
	description: (
		...
		<strong>Empowering Wisdom:</strong> We translate complex charts and calculations into clear, actionable guidance. You don't need to be an expert to benefit from this wisdom.<br />
		<strong>A Modern Approach:</strong> We use technology to deliver ancient knowledge in a simple, fast, and elegant way, blending tradition with innovation.
		</>
	),
  position: "right",
},
  ...
  const stats = [
    { icon: <Award />, value: 2000, label: "Calculations Performed", suffix: "+" },
    { icon: <Users />, value: 500, label: "Happy Users", suffix: "+" },
    { icon: <Calendar />, value: 5, label: "Years of Dedication", suffix: "" },
    ...
    >
      ...
      >
		...
		<div className="flex-1">
			<h3 className="text-2xl font-medium mb-2">Ready for your forecast?</h3>
			<p className="text-white/80">Get your free daily horoscope and zodiac readings.</p>
		</div>
		{/* 👇 Here is the change */}
		<Link to="/">
			<motion.button
			className="bg-[#88734C] hover:bg-gold/90 text-white px-6 py-3 rounded-lg flex items-center gap-2 font-medium transition-colors"
