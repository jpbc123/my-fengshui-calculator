            ...
            <div className="flex flex-col lg:flex-row items-center justify-between gap-6">
              ...
              <div className="text-center lg:text-left lg:flex-shrink-0">
                <div className="flex items-center justify-center lg:justify-start gap-2 mb-2">
                  <div className="w-2 h-2 bg-gradient-to-r from-yellow-300 to-orange-300 rounded-full animate-pulse"></div>
                  <h2 className="text-2xl md:text-3xl font-bold text-white">
                    Chinese Zodiac Love Match
                  </h2>
                  <div className="w-2 h-2 bg-gradient-to-r from-orange-300 to-yellow-300 rounded-full animate-pulse" style={{animationDelay: '0.5s'}}></div>
                </div>
                ...
                <div className="bg-white/95 backdrop-blur-sm rounded-xl p-4 shadow-lg border border-white/30">
                  <div className="flex flex-col sm:flex-row items-center gap-3">
                    ...
                    {/* Compact heart separator */}
                      <div className="relative bg-gradient-to-br from-rose-500 via-pink-500 to-red-500 rounded-full p-3 shadow-2xl transform hover:scale-110 transition-all duration-300">
